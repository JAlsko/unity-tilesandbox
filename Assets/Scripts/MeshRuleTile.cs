...
{
    public class MeshRuleTile<T> : MeshRuleTile
    {
        public sealed override Type m_NeighborType { get { return typeof(T); } }
    }

    [Serializable]
    [CreateAssetMenu(fileName = "New Mesh Rule Tile", menuName = "Tiles/Mesh Rule Tile")]
    public class MeshRuleTile : ScriptableObject
    {
        ...
        public Texture2D m_DefaultSprite;
        public MeshRuleTile m_Self
        {
            get { return m_OverrideSelf != null ? m_OverrideSelf : this; }
            set { m_OverrideSelf = value; }
        }

        protected int[] m_CachedNeighboringTiles = new int[NeighborCount];
        private MeshRuleTile m_OverrideSelf;
        ...
        public class TilingRule
        {
            ...
            public int[] m_SpriteAtlasIndices;
            ...
            public TilingRule()
            {
                ...
                m_Sprites = new Texture2D[1];
                m_SpriteAtlasIndices = new int[1];
                m_GameObject = null;
                m_AnimationSpeed = 1f;
                m_PerlinScale = 0.5f;
