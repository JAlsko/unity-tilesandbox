...
public class Inventory {
	...
	public List<int> openSlots = new List<int>();
	
	public Inventory(int _inventorySize = 32, string _inventoryName = "Chest") {
    ...
    public int SetItem(int itemIndex, ItemObject item) {
