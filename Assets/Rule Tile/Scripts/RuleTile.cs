...
namespace UnityEngine
{
    ...
    public class RuleTile : TileBase
    {
        ...
        public virtual bool RuleMatch(int neighbor, TileBase tile)
        {
            switch (neighbor)
            {
                case TilingRule.Neighbor.This: return tile != null;//tile == m_Self;
                case TilingRule.Neighbor.NotThis: return tile == null;//tile != m_Self;
            }
            return true;
        }
        ...
        protected virtual void GetMatchingNeighboringTiles(ITilemap tilemap, Vector3Int position, ref string[] neighboringTiles, int thisLayer = 0, int thisChunk = 0)
        {
            ...
            neighboringTiles = m_CachedNeighboringTileIDs;
        }
